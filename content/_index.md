...
Computing](https://cs.kaist.ac.kr/) at the [Korea Advanced Institute of Science
and Technology (KAIST)](https://kaist.ac.kr/en/), where I was a member of the
[Computer Architecture and Systems Laboratory
(CASYS)](https://casyslab.kaist.ac.kr/) advised by [Youngjin
...
<style>
.contact-icon { display: inline-block; width: 0.9em; text-align: center; }
</style>
...
<i class="ai ai-orcid contact-icon"></i> [ORCID](https://orcid.org/0000-0002-6877-0189) |
<i class="fab fa-github contact-icon"></i> [GitHub](https://github.com/yulistic)
